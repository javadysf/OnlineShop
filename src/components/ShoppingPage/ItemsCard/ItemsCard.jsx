...
const ItemsCard = ({product}) => {
      return (
        <div className="h-[500px] w-[400px] group bg-white rounded-2xl shadow-md hover:shadow-xl border border-gray-100 transition duration-300 overflow-hidden relative">
        {/* تصویر */}
